...
| 2026-07-26 | Presentation prep: spoken script, interactive-diagram fullscreen controls, diagram payload accuracy | `docs/PRESENTATION_SCRIPT.md` added; flow tabs/mode toggle verified reachable in fullscreen at 1440px and 900px (Chromium, no page errors); triage-flow payloads re-checked against `seed.py`, `detector.py`, `classifier.py`, `ml_classifier.py` | Run the deck and the seven-minute demo end to end once, out loud |
